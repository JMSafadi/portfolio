    ...
    return (
        <div ref={ref} className='projects__section padding_section' id='projects'>
            ...
            <motion.div animate={animation}>
                ...
                <Project image={project4img} gh_code='https://github.com/JMSafadi/challenge' deploy='https://jmsafadi.github.io/challenge/' title='Formulario de encuesta' description='Application created with React that reads a JSON file and generates a survey interface with each item. The survey responses are sent to a Firebase database and then displayed in table format on another route.'/>
